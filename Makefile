...
PARSE_FILE_NAMES = parser.c parser_utils.c init_structs.c parse_map.c map_validity.c map_validity_2.c set_player.c process_line.c pad_map.c put_C_F_color.c color_utils.c color_utils_2.c
